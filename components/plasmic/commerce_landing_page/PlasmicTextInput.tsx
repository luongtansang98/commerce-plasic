...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: bwS5T57_785p/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__dwdqY)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__tqVp)}
              role={"img"}
            />
          ),
