...
import sty from "./PlasmicValue.module.css"; // plasmic-import: yXUIIFdNNdVV/css

import TakeOffIcon from "./icons/PlasmicIcon__TakeOff"; // plasmic-import: 0Lnl5yEz6Cbb/icon
...
function PlasmicValue__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__xMjuS, {
          [sty.freeBoxcenter__xMjuS7BdV2]: hasVariant(
            $state,
            "center",
            "center"
          ),
          [sty.freeBoxtopBottom__xMjuSpy1D7]: hasVariant(
            $state,
            "topBottom",
            "topBottom"
          )
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__niHs)}>
          {renderPlasmicSlot({
            defaultContents: (
              <TakeOffIcon
                className={classNames(projectcss.all, sty.svg__tQ6PJ)}
                role={"img"}
              />
            ),
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__akU3Q, {
          [sty.freeBoxcenter__akU3Q7BdV2]: hasVariant(
            $state,
            "center",
            "center"
          ),
          [sty.freeBoxwithButton__akU3QuX07V]: hasVariant(
            $state,
            "withButton",
            "withButton"
          )
      ...
      {(hasVariant($state, "withButton", "withButton") ? true : false) ? (
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___4RGsd, {
            [sty.freeBoxcenter___4RGsd7BdV2]: hasVariant(
              $state,
              "center",
              "center"
            ),
            [sty.freeBoxwithButton___4RGsduX07V]: hasVariant(
              $state,
              "withButton",
              "withButton"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Button
                className={classNames("__wab_instance", sty.button___2QBsv, {
                  [sty.buttonwithButton___2QBsvuX07V]: hasVariant(
                    $state,
                    "withButton",
                    "withButton"
                  )
                ...
                endIcon={
                  <RightArrowIcon
                    className={classNames(projectcss.all, sty.svg__tSeSu)}
                    role={"img"}
                  />
                }
                rounded={true}
